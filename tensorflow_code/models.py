...
class xvector_bn_mlt(object):
    ...
    def __init__(self, session, is_test_p, n_spk, tdnn_sizes_before_pooling=None, tdnn_sizes_after_pooling=None,
        ...
        log.info("TDNN architecture before pooling: " + str(zip(self.tdnn_sizes_before_pooling,self.activations_before_pooling)) )
        log.info("TDNN architecture after pooling: "  + str(zip(self.tdnn_sizes_after_pooling,self.activations_after_pooling)) )       
...
class tdnn_stack(object):
    ...
    def __init__(self, session, is_test_p, tdnn_sizes=None, activations=None, it_tr_que=None,
        ...
        log.info("TDNN architecture: " + str(zip(self.tdnn_sizes,self.activations)) )
