...
import sys, os, cPickle, copy, subprocess, time, inspect 
...
#############################################################################
    ...
    _, _, _, C_m_ = model( X1_p, C1_p, annoying_train ) # Classifications      
...
#############################################################################    
    ...
    min_op        = optim.apply_gradients(zip(grads_,vars_))
